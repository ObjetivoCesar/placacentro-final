        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: "Eres un asistente especializado en extraer texto de imágenes. Analiza esta imagen y extrae todo el texto visible, incluyendo medidas, especificaciones técnicas, notas manuscritas o cualquier información textual relevante. Si no hay texto visible, responde 'No se detectó texto en la imagen'."
              },
              {
                type: "image_url",
                image_url: {
